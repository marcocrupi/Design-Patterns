// L'Adapter pattern è un pattern di comportamento che consente di utilizzare classi con interfacce incompatibili.
// Consente di adattare un'interfaccia di una classe per farla lavorare con un'altra interfaccia.
